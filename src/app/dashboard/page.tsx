...
const ADVICE_STR: Record<string, { title: string; body1: string; body2: string; tip: string; ok: string }> = {
  id: { title: 'Saran Modal', body1: 'Sebaiknya siapkan modal minimal', body2: 'Kalau modal terlalu kecil, beberapa kali kalah beruntun bisa langsung menghabiskannya.', tip: 'Belum punya modal segitu? Pakai mode Demo dulu — gratis dan tanpa risiko.', ok: 'Mengerti' },
  en: { title: 'Capital Advice', body1: 'We suggest starting with at least', body2: 'With a smaller balance, a few losses in a row can wipe it out quickly.', tip: 'Not there yet? Use Demo mode first — free and risk-free.', ok: 'Got it' },
  ru: { title: 'Совет по капиталу', body1: 'Рекомендуем начинать минимум с', body2: 'При меньшем балансе несколько проигрышей подряд могут быстро его обнулить.', tip: 'Пока меньше? Начните с режима Демо — бесплатно и без риска.', ok: 'Понятно' },
  es: { title: 'Consejo de capital', body1: 'Te sugerimos empezar con al menos', body2: 'Con un saldo menor, unas pocas pérdidas seguidas pueden agotarlo rápido.', tip: '¿Aún no? Usa el modo Demo primero: gratis y sin riesgo.', ok: 'Entendido' },
  ms: { title: 'Saranan Modal', body1: 'Sebaiknya sediakan modal sekurang-kurangnya', body2: 'Jika modal terlalu kecil, beberapa kekalahan berturut-turut boleh menghabiskannya.', tip: 'Belum cukup? Guna mod Demo dahulu — percuma dan tanpa risiko.', ok: 'Faham' },
};
