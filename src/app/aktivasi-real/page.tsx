        ...
        <div style={sx.wrap}>
          <div style={{ ...sx.card, textAlign: 'center', padding: '44px 26px' }}>
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.6, color: '#9aa6a1', maxWidth: 360, margin: '0 auto' }}>
              Pengajuan kamu <b style={{ color: '#f4f6f5' }}>sedang diproses</b>, mohon menunggu. Pembayaran diverifikasi admin dan Mode <b style={{ color: '#f4f6f5' }}>REAL</b> akan aktif pada akun <b style={{ color: AC }}>{sid}</b> biasanya dalam ~10 menit.
            </p>
            <div style={{ marginTop: 18, padding: '13px 15px', borderRadius: 14, background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.22)', maxWidth: 360, marginInline: 'auto' }}>
              ...
              <a href="mailto:supportstockity@gmail.com?subject=Aktivasi%20REAL%20belum%20diproses" style={{ display: 'inline-block', marginTop: 8, fontSize: 13, fontWeight: 700, color: AC, textDecoration: 'none' }}>✉️ supportstockity@gmail.com</a>
            </div>
          </div>
        </div>
      </div>
