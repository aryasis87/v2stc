// Translations for Stockity AutoTrade
...
const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    login: {
      title: 'Welcome back!',
      subtitle: 'Sign in to continue to your Stockity account',
      email: 'Email',
      ...
      tutorial: {
        ...
        btnLabel: 'How to register on Stockity',
        ...
        step2Text: 'Congratulations! A success message will appear. Tap "Login Stockity AutoTrade" to go to the login page 🎉',
        step3Title: 'Step 3 — Sign In',
        step3Text: 'Almost done! Enter the email and password you registered, then tap login. Welcome to Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'Profile',
      ...
      help: 'Help & Legal',
      logout: 'Logout',
      logoutConfirm: 'Logout from Stockity AutoTrade',
  ...
  id: {
    ...
    login: {
      ...
      subtitle: 'Masuk untuk melanjutkan ke akun Stockity Anda',
      email: 'Email',
      ...
      notWhitelisted: 'Akun Anda belum terdaftar di Stockity. Silakan hubungi admin untuk proses verifikasi.',
      ...
      tutorial: {
        ...
        step2Text: 'Selamat! Akan muncul pesan sukses. Tekan tombol "Login Stockity AutoTrade" untuk menuju halaman login 🎉',
        step3Title: 'Langkah 3 — Masuk ke Akun',
        step3Text: 'Hampir selesai! Masukkan email dan password yang tadi didaftarkan, lalu tekan login. Selamat bergabung di Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'Profil',
      ...
      logout: 'Keluar',
      logoutConfirm: 'Keluar dari Stockity AutoTrade',
      ...
      financialInfo: 'Informasi Finansial',
  ...
  ru: {
    ...
    login: {
      ...
      tutorial: {
        ...
        btnLabel: 'Как зарегистрироваться в Stockity',
        btnAction: 'смотреть',
        next: 'Далее',
        done: 'Готово',
        close: 'Закрыть',
        ...
        step2Text: 'Поздравляем! Появится сообщение об успехе. Нажмите «Войти в Stockity AutoTrade» 🎉',
        step3Title: 'Шаг 3 — Войдите в систему',
        step3Text: 'Почти готово! Введите email и пароль, нажмите войти. Добро пожаловать в Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'Профиль',
      ...
      logout: 'Выйти',
      logoutConfirm: 'Выйти из Stockity AutoTrade',
  ...
  es: {
    ...
    login: {
      ...
      tutorial: {
        ...
        btnLabel: 'Cómo registrarse en Stockity',
        ...
        step2Text: '¡Felicitaciones! Aparecerá un mensaje de éxito. Toca "Iniciar sesión Stockity AutoTrade" 🎉',
        step3Title: 'Paso 3 — Inicia Sesión',
        step3Text: '¡Casi listo! Ingresa correo y contraseña registrados y toca iniciar sesión. ¡Bienvenido a Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'Perfil',
      ...
      logoutConfirm: 'Cerrar sesión de Stockity AutoTrade',
      ...
      totalDeposit: 'Depósitos totales',
      bonus: 'Bono',
  ...
  ms: {
    ...
    login: {
      ...
      tutorial: {
        ...
        step2Text: 'Tahniah! Mesej kejayaan akan muncul. Ketik "Log Masuk Stockity AutoTrade" 🎉',
        step3Title: 'Langkah 3 — Log Masuk',
        step3Text: 'Hampir selesai! Masukkan emel dan kata laluan yang baru didaftarkan. Selamat datang ke Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'Profil',
      ...
      logout: 'Log Keluar',
      logoutConfirm: 'Log keluar dari Stockity AutoTrade',
  ...
  hi: {
    ...
    login: {
      ...
      tutorial: {
        ...
        btnLabel: 'Stockity में कैसे रजिस्टर करें',
        ...
        step2Text: 'बधाई! सफलता संदेश दिखाई देगा। "Stockity AutoTrade में लॉगिन करें" दबाएं 🎉',
        step3Title: 'चरण 3 — साइन इन करें',
        step3Text: 'लगभग हो गया! ईमेल और पासवर्ड दर्ज करें और लॉगिन दबाएं। Stockity AutoTrade में स्वागत है! 🚀',
      },
    },
    profile: {
      title: 'प्रोफ़ाइल',
      ...
      logout: 'लॉगआउट',
      logoutConfirm: 'Stockity AutoTrade से लॉगआउट करें',
  ...
  th: {
    ...
    login: {
      ...
      tutorial: {
        ...
        btnLabel: 'วิธีลงทะเบียน Stockity',
        ...
        step2Text: 'ยินดีด้วย! ข้อความสำเร็จจะปรากฏ กดปุ่ม "เข้าสู่ระบบ Stockity AutoTrade" 🎉',
        step3Title: 'ขั้นตอนที่ 3 — เข้าสู่ระบบ',
        step3Text: 'เกือบเสร็จแล้ว! กรอกอีเมลและรหัสผ่านที่ลงทะเบียนไว้ แล้วกดเข้าสู่ระบบ ยินดีต้อนรับสู่ Stockity AutoTrade! 🚀',
      },
    },
    profile: {
      title: 'โปรไฟล์',
      ...
      logout: 'ออกจากระบบ',
      logoutConfirm: 'ออกจาก Stockity AutoTrade',
      ...
      totalDeposit: 'ยอดฝากรวม',
      bonus: 'โบนัส',
      accountTier: 'ระดับบัญชี',
      id: 'ID',
  ...
  tr: {
    ...
    login: {
      ...
      tutorial: {
        ...
        btnLabel: "Stockity'ye nasıl kaydolunur",
        ...
        step2Text: "Tebrikler! Başarı mesajı görünecek. 'Stockity AutoTrade'e Giriş Yap' butonuna basın 🎉",
        step3Title: 'Adım 3 — Giriş Yapın',
        step3Text: "Neredeyse bitti! E-posta ve şifreyi girin, girişe basın. Stockity AutoTrade'e hoş geldiniz! 🚀",
      },
    },
    profile: {
      title: 'Profil',
      ...
      help: 'Yardım & Hukuki',
      logout: 'Çıkış Yap',
      logoutConfirm: "Stockity AutoTrade'den çıkış yap",
